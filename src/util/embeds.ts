...
export function createEmbed(
	...
	embed.setTimestamp();
	embed.setFooter({
		text: `Made with ❤️ by ${config.AUTHOR} in Germany`,
...
export function createUnionErrorEmbed() {
	return createErrorEmbed(
		"This server has not created or joined a union yet! Please ask the sever's administrators to set this feature up."
	);
}
